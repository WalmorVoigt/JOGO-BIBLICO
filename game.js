...
class BiblicalGame {
  ...
  showResults(percentage) {
    ...
    this.showScreen('resultContainer');
  }
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  window.startGame = (level) => game.startGame(level);
  window.checkLevel = (level) => game.checkLevel(level);
  ...
  window.shareResult = () => game.shareResult();
});